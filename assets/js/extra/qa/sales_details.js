...
function createLink(sCli){
	var sHtmlContent = '';
	sHtmlContent +='<a href="javascript:void(0)" onclick="javascript:AddEditPopUp(\''+sCli+'\')"><img src="'+BASEURL+'assets/images/icon/edit.png" alt="EDIT" title="EDIT" ></a>&nbsp;';
	sHtmlContent +='<a href="javascript:void(0)" onclick="javascript:Delete_Package(\''+sCli+'\')"><img src="'+BASEURL+'assets/images/icon/delete.png" alt="DELETE" title="DELETE" ></a>&nbsp;';
	return sHtmlContent;
}
